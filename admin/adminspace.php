...
<body>        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
          <div class="navbar-header">
              <img class="logoEntete" src="http://localhost/CoursInformatique/img/logo.png">
              <a class="navbar-brand Entete" href="http://localhost/CoursInformatique/pages/accueil.php">Cours Informatique</a>
          </div>
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> Changer mot de passe</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="http://localhost/CoursInformatique/admin/logoutadmin.php"><i class="fa fa-sign-out fa-fw"></i> Déconnexion</a>
                        </li>
                    </ul>
                </li>
            </ul>
